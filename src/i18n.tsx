...
const zh: Record<string, string> = {
  ...
  'empty.subtitleAuthed': '打开已有计划继续推进，或新建一个计划开始排期。',
  'empty.subtitleGuest': '登录后即可查看、编辑与协同团队计划。',
  ...
  'toolbar.zoomMonth': '月',
  'toolbar.today': '今天',
  'toolbar.criticalPath': '关键路径',
  'toolbar.criticalPathHint': '关键路径：slack=0 的叶子任务（不在 schedule 范围，开关仅前端计算）',
  'toolbar.themeLight': '浅色',
  'toolbar.themeDark': '深色',
  'toolbar.themeSystem': '跟随系统',
  'toolbar.themeHint': '切换浅色 / 深色主题；跟随系统会响应 macOS 外观变更',
  'toolbar.themeLightShort': '浅',
  'toolbar.themeDarkShort': '深',
  'toolbar.themeSystemShort': '自',
  ...
  'task.placeholderDuration': '0d = 里程碑 / 5d / 2w / 1m',
  ...
  'gantt.makeup': '补班',
  'gantt.unnamed': '（未命名）',
  'gantt.range': '区间：{start} → {end}（K3 端点式，含结束日 = 下班时间，2026-09-07）',
  'gantt.durationSrc': '时长：{dur}　来源：{src}',
  'gantt.parentSummary': '父任务：时间由子任务汇总',
  'gantt.legendTask': '任务',
  'gantt.legendSummary': '父任务汇总',
  'gantt.legendMilestone': '里程碑（duration=0）',
  'gantt.legendCritical': '关键路径（红下划线）',
  ...
  'gantt.milestoneTitle': '里程碑：{date}',
  'gantt.milestoneSummary': '里程碑汇总（{count}）',
...
const en: Record<string, string> = {
  ...
  'empty.newPlan': 'New Plan',
  'empty.pickUserFirst': 'Pick your identity first',
  'empty.subtitleAuthed': 'Open an existing plan to continue, or create a new one to start scheduling.',
  'empty.subtitleGuest': 'Sign in to view, edit, and collaborate on team plans.',
  ...
  'toolbar.criticalPathHint': 'Critical path: leaves with slack=0 (frontend-only compute; not on the server)',
  'toolbar.themeLight': 'Light',
  'toolbar.themeDark': 'Dark',
  'toolbar.themeSystem': 'System',
  'toolbar.themeHint': 'Switch light/dark theme; System follows macOS appearance',
  'toolbar.themeLightShort': 'L',
  'toolbar.themeDarkShort': 'D',
  'toolbar.themeSystemShort': 'A',
  ...
  'task.placeholderDuration': '0d = milestone / 5d / 2w / 1m',
  'task.parentLocked': 'Rolled up from subtasks',
  ...
  'gantt.range': 'Range: {start} → {end} (K3 ENDPOINT, end-inclusive = end-of-day, 2026-09-07)',
  ...
  'gantt.legendMilestone': 'Milestone (duration=0)',
  'gantt.legendCritical': 'Critical path (red underline)',
  ...
  'gantt.milestoneTitle': 'Milestone: {date}',
  'gantt.milestoneSummary': 'Milestone summary ({count})',
