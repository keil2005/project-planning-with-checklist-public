...
const zh: Record<string, string> = {
  ...
  'team.name': '名称',
  'team.color': '颜色',
  'team.emptyTeams': '暂无团队，点「新增」创建第一个。',
  'team.emptyPeople': '暂无人员登记，点「新增」开始。',
  'team.membersCount': '{n} 人',
  'team.unassigned': '未分组',
  'team.confirmDeleteTeam': '确定删除团队「{name}」？成员不会被删除，只是脱离该团队。',
  'team.confirmDeletePerson': '确定删除人员「{name}」？已用在任务里的名字仍保留（重新打开计划会自动重建无元数据条目）。',
  'person.name': '姓名',
  'person.gender': '性别',
  'person.genderMale': '男',
  'person.genderFemale': '女',
  'person.genderUnset': '未指定',
  'person.teams': '所属团队',
  'person.teamsHelp': '多选；人员可同时属于多个团队。',
  'person.unknownInRegistry': '未登记',
  'genderTag.male': '♂',
  'genderTag.female': '♀',
  ...
  'filter.crossFunctional': 'Cross-functional',
  'filter.crossFunctionalTip': '按「团队」维度跨部门筛选：勾选 1+ 团队后，任务 owner/consultant 至少有一人属于其中之一才会显示',
  'filter.crossFunctionalTipNoTeams': '请先在工具栏「团队管理」中创建团队',
  'filter.crossFunctionalTitle': '按团队筛选',
  'filter.crossIncludeUnassigned': '保留「无团队人员」对应的任务',
  'filter.crossIncludeUnassignedHelp': '关闭后只显示所选团队的成员所接活的任务；新建团队时建议保持开启以防漏看',
  'filter.crossSelectAll': '（全选）',
  'filter.crossHideUnassigned': '（不含未分配）',
  'filter.crossSearchPlaceholder': '搜索团队',
  'filter.crossNoTeams': '尚无团队。请先在工具栏「团队管理」中创建。',
  'filter.summaryCrossFunctional': '跨部门：{teams}',
...
const en: Record<string, string> = {
  ...
  /* v1.4.1+ Team & People */
  'team.title': 'Teams & People',
  'team.tabTeams': 'Teams',
  'team.tabPeople': 'People',
  'team.add': 'Add',
  'team.edit': 'Edit',
  'team.delete': 'Delete',
  'team.name': 'Name',
  'team.color': 'Color',
  'team.emptyTeams': 'No teams yet — click Add to create the first one.',
  'team.emptyPeople': 'No people registered yet — click Add to start.',
  'team.membersCount': '{n}',
  'team.unassigned': 'Unassigned',
  'team.confirmDeleteTeam': 'Delete team "{name}"? Members are not removed, only detached from the team.',
  'team.confirmDeletePerson': 'Delete person "{name}"? Names already used in tasks stay (reopening the plan auto-rebuilds them as plain entries).',
  'person.name': 'Name',
  'person.gender': 'Gender',
  'person.genderMale': 'Male',
  'person.genderFemale': 'Female',
  'person.genderUnset': 'Not set',
  'person.teams': 'Teams',
  'person.teamsHelp': 'Multi-select — one person can belong to multiple teams.',
  'person.unknownInRegistry': 'Unregistered',
  'genderTag.male': '♂',
  'genderTag.female': '♀',
  ...
  'filter.crossFunctional': 'Cross-functional',
  'filter.crossFunctionalTip': 'Filter by team: show only tasks whose owner/consultant belongs to one of the selected teams',
  'filter.crossFunctionalTipNoTeams': 'Create teams in the toolbar "Teams" manager first',
  'filter.crossFunctionalTitle': 'Filter by team',
  'filter.crossIncludeUnassigned': 'Also include tasks of people with no team',
  'filter.crossIncludeUnassignedHelp': 'When off, only tasks owned/consulted by members of the selected teams are shown',
  'filter.crossSelectAll': '(Select all)',
  'filter.crossHideUnassigned': ' (no unassigned)',
  'filter.crossSearchPlaceholder': 'Search teams',
  'filter.crossNoTeams': 'No teams yet. Create them in the toolbar "Teams" manager.',
  'filter.summaryCrossFunctional': 'Cross-functional: {teams}',
