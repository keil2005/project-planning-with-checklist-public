...
| 团队与人员管理 | 自建团队（6 色色板 + 自定义色），为成员设置性别与多团队归属；任务表「负责人」列显示微信风性别色点 + 团队 chip |
| 跨部门筛选 | 按团队多选筛选任务（负责人 / 顾问人任一人匹配即命中），可与「Assign to me」及列筛选叠加 |
...
工具栏 **Teams & People** 维护团队与人员（性别 / 多团队归属），任务表「负责人」列直接显示微信风性别色点与团队 chip；FilterBar 的 **Cross-functional** 按钮按团队多选筛选任务，可与「Assign to me」叠加使用。
